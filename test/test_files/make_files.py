...
# save also hiss
det1 = Histogram(hist.new.Reg(4000,0,4000,name = "axis_1").Double().fill([100,200,2000]))
det2 = Histogram(hist.new.Reg(4000,0,4000,name = "axis_1").Double().fill([300]))
det3 = Histogram(hist.new.Reg(4000,0,4000,name = "axis_1").Double().fill([1000,3000]))

lh5.write(Struct({"det1":det1,"det2":det2,"det3":det3}),"hit",f"pdf_data.lh5",wo_mode="of")
